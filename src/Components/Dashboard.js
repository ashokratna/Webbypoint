    ...
    componentDidMount(){
        ...
        callback: data=>{
            if(localStorage.getItem('authData')) {
                ...
                const  particularEmployee = lodash.filter(data.Projects.elements, emp => emp['Dev1 Name'].toLowerCase() === JSON.parse(localStorage.getItem('authData')).name.toLowerCase() || emp['Dev2 Name'].toLowerCase() === JSON.parse(localStorage.getItem('authData')).name.toLowerCase() || emp['Dev3 Name'].toLowerCase() === JSON.parse(localStorage.getItem('authData')).name.toLowerCase() || emp['Dev4 Name'].toLowerCase() === JSON.parse(localStorage.getItem('authData')).name.toLowerCase() || emp['Dev5 Name'].toLowerCase() === JSON.parse(localStorage.getItem('authData')).name.toLowerCase() || emp['Dev6 Name'].toLowerCase() === JSON.parse(localStorage.getItem('authData')).name.toLowerCase());
